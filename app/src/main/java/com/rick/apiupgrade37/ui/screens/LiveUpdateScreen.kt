 ...
 *      Shows how apps can apply universally understood colors to text in notifications and promote ongoing notifications.
 *
 *  Live Updates
 *      real time notifications with icons
 *      before they were all black and white with no visual distinction
 *      now: semantic colors, promoted ongoing
 *          LEVELS for Importance, Severity, Concern, Information
 *      now: updates are sent to top of notifications for importance ordering
 *
 * Use Cases:
 *    Health apps - show critical health alerts
 *    Ride Sharing apps - show driver is 2 min away
 *    Navigation - ETA: 15 min with (green = on time)
 *
